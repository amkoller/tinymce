    ...
    function test() {
      console.log('test!');
        ...
        console.log(self);
          ...
          $content.filter('[style]').each(function(i, elm) {
      ...
      var valuesetter = function() { return items; }
            ...
            //editor.curFont = e.control.settings.value;
					}
				}
			};
		});
...
define("tinymce/ui/MenuButton", [
	...
	var MenuButton = Button.extend({
      ...
      if (typeof tinymce.menuobj === 'undefined')
        tinymce.menuobj = [];
      tinymce.menuobj[tinymce.menuobj.length] = self.menu;
		},
...
define("tinymce/ui/ListBox", [
	...
	return MenuButton.extend({
      ...
      if (settings.values instanceof Function)
